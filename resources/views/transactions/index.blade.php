...
<x-app-layout>
    ...
    <div class="py-4 max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="flex flex-wrap gap-3 p-4 mb-6 border border-gray-300 bg-white rounded-md shadow-sm items-center">
            ...
            {{-- Category Filter --}}
            <form method="GET" action="{{ route('transactions.index') }}" class="flex items-center gap-2 ml-auto" id="categoryFilterForm">
                ...
                <tbody class="divide-y-2 divide-gray-300">
                    @forelse ($transactions as $t)
                        ...
                        class="hover:bg-gray-100 cursor-pointer transition" 
                            ...
                            <td class="px-6 py-4 whitespace-nowrap font-semibold bg-red-50 text-red-600">{{ $t->type === 'cash_out' ? '- ₹'. number_format($t->amount, 2) : '' }}</td>
                        </tr>
                    @empty
                        <tr>
